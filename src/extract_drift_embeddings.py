...
# Extract Drift Embeddings
def extract_drift_embeddings():
    loader = get_loader()
    ...
    np.save(
        OUTPUT_DIR/"drift_embeddings.npy",
        embeddings
    )

    np.save(
        OUTPUT_DIR/"drift_labels.npy",
        labels
    )

    print("Saved drift embeddings.")

# Main Function
if __name__ == "__main__":
    extract_drift_embeddings()